...
def usage():
    usage = "----------------- Usage ----------------\n"
    usage += "./CombineRules.py <random seed> <number of rules> <number of patterns per rule> <number of variables> <output format> *<pattern files>"
    return usage

def generate_rule(samples, new_vars, output_file):
    vars_used = set()
    conjuncts = []
...
if __name__ == '__main__':
    ...
    for i in range(number_of_rules):
        ...
        generate_rule(samples, new_vars, output_file)
